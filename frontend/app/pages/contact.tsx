...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Contact || Auroni ERP" },
    { name: "description", content: "Have questions or need support? Contact our team to learn how our ERP solutions can transform your business." },
  ];
}
